	...
	{{#each connections}}
		<li class="view-profile">
			...
			<div class="candidate-info">
				...
				<div class="candidate-job">{{#hasPrimaryWorkHistory tthis.attributes.primaryWorkHistory}}{{this.attributes.primaryWorkHistory.jobs.[0].name}} @ {{this.attributes.primaryWorkHistory.employer.name}}{{else}}{{../../language.notAvailable}}{{/hasPrimaryWorkHistory}}</div>
			</div>
