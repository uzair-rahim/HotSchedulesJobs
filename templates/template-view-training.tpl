...
<div id="app-alert-training-job" class="app-alert training show">
	...
	<div class="alert-body">
		...
		<p>Click <strong>"Save"</strong> when you're done editing details. Your Job is now available for candidates to see!</p>
	</div>
	<div class="alert-action">
		<button class="close-training">Close</button>
		<button id="continue-job" class="primary">Continue</button>
	</div>
</div>
...
<div id="app-alert-training-spread" class="app-alert training">
	...
	<div class="alert-body">
		...
		<ul>
			...
			<li>Followers <span>(People following your store via HS Post)</span></li>
		</ul>
		<p>You can also share a job directly by copying the job link and pasting it into other applications!</p>
	</div>
	<div class="alert-action">
		<button class="close-training">Close</button>
...
<div id="app-alert-training-talent" class="app-alert training">
	...
	<div class="alert-action">
		<button class="close-training">Close</button>
		<button id="finish-talent" class="primary">Finish</button>
		<button id="back-talent">Back</button>
	</div>
</div>